...
When generating the four clusters, the non-hierarchical k-means algorithm grouped the countries according to their GDP per capita and GNI per capita, while the other variables used in the clustering algorithm (i.e., GNI in USD, GDP growth and GNI growth) do not reflect the same underlying pattern. 
